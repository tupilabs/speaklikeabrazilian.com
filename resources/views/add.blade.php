                ...
                <div class='fourteen wide column'>
                    ...
                    <form class="ui form" method="post" action="{{ action('ExpressionController@postAdd') }}">
                        ...
                        <div class="field">
                            ...
                            <textarea name="expression-description-input" id="expression-description-input"></textarea>
                        </div>
                        <div class="field">
                            <label for="expression-example-input">Example in Portuguese</label>
                            <textarea name="expression-example-input" id="expression-example-input"></textarea>
                        </div>
                        <div class="field">
                            <label for="expression-tags-input">Tags</label>
                            <input name="expression-tags-input" id="expression-tags-input" placeholder="Comma separated list of tags and similar expressions" type="text" />
                        </div>
                        <div class="two fields">
                            <div class="field">
                                <label for="expression-pseudonym-input">Your pseudonym</label>
                                <input name="expression-pseudonym-input" id="expression-pseudonym-input" placeholder="Your pseudonym" type="text" />
                            </div>
                            <div class="field">
