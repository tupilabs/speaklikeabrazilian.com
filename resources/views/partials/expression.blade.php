					<div class="ui fluid card">
					  	<div class="content">
                            ...
                            @endif
					    	<div class="header"><a href="{{ URL::to($selected_language['slug'] . '/expression/define') }}?e={{ urlencode($definition['text']) }}">{{ $definition['text'] }}</a><a class='tts' href="http://translate.google.com/translate_tts?ie=UTF-8&total=1&idx=0&textlen=32&client=tw-ob&q={{ $definition['text'] }}&tl=pt-br"><i class="unmute icon"></i></a></div>
					    	<div class="meta">
