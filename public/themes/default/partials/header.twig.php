<nav class="navbar navbar-default navbar-fixed-top" role="navigation" id="nav-header">
    <div class="navbar-collapse" id="navbar-collapse-01" style="">
    	<a href="{{ URL.action('ExpressionController@getNew') }}" class='hidden-xs btn btn-menu navbar-btn btn-xs'>SLBR Home</a>
    	...
    	<a href="{{ URL.action('ModeratorController@getModerators') }}" class='hidden-xs btn btn-sm btn-info navbar-btn btn-xs'>Moderators area</a>
        ...
        <a href='{{ URL.to('/de') }}' class=''><img src='/themes/default/assets/img/flags/flag_germany.png' width="24px" /></a>
	</div>
</nav>
<section id='header'>
    <div class='container'>
        <div class='row'>
            ...
            <div class='col-xs-12 visible-xs'>
                <h5 class='title'>Speak Like A Brazilian</h5>
            </div>
	    </div>
	    <div class='row'>
