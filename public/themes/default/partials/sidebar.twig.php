			<div class='hidden-xs col-md-2 col-lg-2 center' id="sidebar" style="margin-top: 15px;">
    			<a href="{{ URL.action('ExpressionController@getAdd') }}" class="btn btn-embossed btn-wide btn-success"><strong><span class="fui-plus"></span> {{ Lang.get('messages.add_expression') }}</a></strong>
    			<hr/>
